...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Dispatching::DispatcherQueueTimer) CreateTimer() const;
        WINRT_IMPL_AUTO(bool) TryEnqueue(winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler const& callback) const;
        WINRT_IMPL_AUTO(bool) TryEnqueue(winrt::Microsoft::UI::Dispatching::DispatcherQueuePriority const& priority, winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler const& callback) const;
        WINRT_IMPL_AUTO(winrt::event_token) ShutdownStarting(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Microsoft::UI::Dispatching::DispatcherQueueShutdownStartingEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) ShutdownCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Dispatching::DispatcherQueueController) CreateOnDedicatedThread() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Dispatching::DispatcherQueueController) CreateOnCurrentThread() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Dispatching::DispatcherQueue) GetForCurrentThread() const;
    };
    ...
    struct consume_Microsoft_UI_Dispatching_IDispatcherQueueTimer
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) Tick(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueueTimer, winrt::Windows::Foundation::IInspectable> const& handler) const;
