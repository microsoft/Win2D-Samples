...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) AllCaps() const;
        WINRT_IMPL_AUTO(void) AllCaps(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Bold() const;
        WINRT_IMPL_AUTO(void) Bold(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Hidden() const;
        WINRT_IMPL_AUTO(void) Hidden(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Italic() const;
        WINRT_IMPL_AUTO(void) Italic(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::LinkType) LinkType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Name() const;
        WINRT_IMPL_AUTO(void) Name(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Outline() const;
        WINRT_IMPL_AUTO(void) Outline(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Position() const;
        WINRT_IMPL_AUTO(void) Position(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) ProtectedText() const;
        WINRT_IMPL_AUTO(void) ProtectedText(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Size() const;
        WINRT_IMPL_AUTO(void) Size(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) SmallCaps() const;
        WINRT_IMPL_AUTO(void) SmallCaps(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Spacing() const;
        WINRT_IMPL_AUTO(void) Spacing(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Strikethrough() const;
        WINRT_IMPL_AUTO(void) Strikethrough(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Subscript() const;
        WINRT_IMPL_AUTO(void) Subscript(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) Superscript() const;
        WINRT_IMPL_AUTO(void) Superscript(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::TextScript) TextScript() const;
        WINRT_IMPL_AUTO(void) TextScript(winrt::Microsoft::UI::Text::TextScript const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::UnderlineType) Underline() const;
        WINRT_IMPL_AUTO(void) Underline(winrt::Microsoft::UI::Text::UnderlineType const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Weight() const;
        WINRT_IMPL_AUTO(void) Weight(int32_t value) const;
        WINRT_IMPL_AUTO(void) SetClone(winrt::Microsoft::UI::Text::ITextCharacterFormat const& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextCharacterFormat) GetClone() const;
        WINRT_IMPL_AUTO(bool) IsEqual(winrt::Microsoft::UI::Text::ITextCharacterFormat const& format) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::CaretType) CaretType() const;
        WINRT_IMPL_AUTO(void) CaretType(winrt::Microsoft::UI::Text::CaretType const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) DefaultTabStop() const;
        WINRT_IMPL_AUTO(void) DefaultTabStop(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextSelection) Selection() const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextCharacterFormat) GetDefaultCharacterFormat() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextParagraphFormat) GetDefaultParagraphFormat() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextRange) GetRange(int32_t startPosition, int32_t endPosition) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextRange) GetRangeFromPoint(winrt::Windows::Foundation::Point const& point, winrt::Microsoft::UI::Text::PointOptions const& options) const;
        WINRT_IMPL_AUTO(void) GetText(winrt::Microsoft::UI::Text::TextGetOptions const& options, hstring& value) const;
        WINRT_IMPL_AUTO(void) LoadFromStream(winrt::Microsoft::UI::Text::TextSetOptions const& options, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        WINRT_IMPL_AUTO(void) Redo() const;
        WINRT_IMPL_AUTO(void) SaveToStream(winrt::Microsoft::UI::Text::TextGetOptions const& options, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        WINRT_IMPL_AUTO(void) SetDefaultCharacterFormat(winrt::Microsoft::UI::Text::ITextCharacterFormat const& value) const;
        WINRT_IMPL_AUTO(void) SetDefaultParagraphFormat(winrt::Microsoft::UI::Text::ITextParagraphFormat const& value) const;
        WINRT_IMPL_AUTO(void) SetText(winrt::Microsoft::UI::Text::TextSetOptions const& options, param::hstring const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ParagraphAlignment) Alignment() const;
        WINRT_IMPL_AUTO(void) Alignment(winrt::Microsoft::UI::Text::ParagraphAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) FirstLineIndent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) KeepTogether() const;
        WINRT_IMPL_AUTO(void) KeepTogether(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) KeepWithNext() const;
        WINRT_IMPL_AUTO(void) KeepWithNext(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LeftIndent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineSpacing() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::LineSpacingRule) LineSpacingRule() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::MarkerAlignment) ListAlignment() const;
        WINRT_IMPL_AUTO(void) ListAlignment(winrt::Microsoft::UI::Text::MarkerAlignment const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::MarkerStyle) ListStyle() const;
        WINRT_IMPL_AUTO(void) ListStyle(winrt::Microsoft::UI::Text::MarkerStyle const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) ListTab() const;
        WINRT_IMPL_AUTO(void) ListTab(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::MarkerType) ListType() const;
        WINRT_IMPL_AUTO(void) ListType(winrt::Microsoft::UI::Text::MarkerType const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) NoLineNumber() const;
        WINRT_IMPL_AUTO(void) NoLineNumber(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) PageBreakBefore() const;
        WINRT_IMPL_AUTO(void) PageBreakBefore(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RightIndent() const;
        WINRT_IMPL_AUTO(void) RightIndent(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) RightToLeft() const;
        WINRT_IMPL_AUTO(void) RightToLeft(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ParagraphStyle) Style() const;
        WINRT_IMPL_AUTO(void) Style(winrt::Microsoft::UI::Text::ParagraphStyle const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::FormatEffect) WidowControl() const;
        WINRT_IMPL_AUTO(void) WidowControl(winrt::Microsoft::UI::Text::FormatEffect const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) TabCount() const;
        WINRT_IMPL_AUTO(void) AddTab(float position, winrt::Microsoft::UI::Text::TabAlignment const& align, winrt::Microsoft::UI::Text::TabLeader const& leader) const;
        WINRT_IMPL_AUTO(void) ClearAllTabs() const;
        WINRT_IMPL_AUTO(void) DeleteTab(float position) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextParagraphFormat) GetClone() const;
        WINRT_IMPL_AUTO(void) GetTab(int32_t index, float& position, winrt::Microsoft::UI::Text::TabAlignment& align, winrt::Microsoft::UI::Text::TabLeader& leader) const;
        WINRT_IMPL_AUTO(bool) IsEqual(winrt::Microsoft::UI::Text::ITextParagraphFormat const& format) const;
        WINRT_IMPL_AUTO(void) SetClone(winrt::Microsoft::UI::Text::ITextParagraphFormat const& format) const;
        WINRT_IMPL_AUTO(void) SetIndents(float start, float left, float right) const;
        WINRT_IMPL_AUTO(void) SetLineSpacing(winrt::Microsoft::UI::Text::LineSpacingRule const& rule, float spacing) const;
    };
    ...
    struct consume_Microsoft_UI_Text_ITextRange
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextCharacterFormat) CharacterFormat() const;
        WINRT_IMPL_AUTO(void) CharacterFormat(winrt::Microsoft::UI::Text::ITextCharacterFormat const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextRange) FormattedText() const;
        WINRT_IMPL_AUTO(void) FormattedText(winrt::Microsoft::UI::Text::ITextRange const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) EndPosition() const;
        WINRT_IMPL_AUTO(void) EndPosition(int32_t value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::RangeGravity) Gravity() const;
        WINRT_IMPL_AUTO(void) Gravity(winrt::Microsoft::UI::Text::RangeGravity const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextParagraphFormat) ParagraphFormat() const;
        WINRT_IMPL_AUTO(void) ParagraphFormat(winrt::Microsoft::UI::Text::ITextParagraphFormat const& value) const;
        ...
        WINRT_IMPL_AUTO(void) ChangeCase(winrt::Microsoft::UI::Text::LetterCase const& value) const;
        WINRT_IMPL_AUTO(void) Collapse(bool value) const;
        WINRT_IMPL_AUTO(void) Copy() const;
        WINRT_IMPL_AUTO(void) Cut() const;
        WINRT_IMPL_AUTO(int32_t) Delete(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count) const;
        WINRT_IMPL_AUTO(int32_t) EndOf(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) Expand(winrt::Microsoft::UI::Text::TextRangeUnit const& unit) const;
        WINRT_IMPL_AUTO(int32_t) FindText(param::hstring const& value, int32_t scanLength, winrt::Microsoft::UI::Text::FindOptions const& options) const;
        WINRT_IMPL_AUTO(void) GetCharacterUtf32(uint32_t& value, int32_t offset) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::ITextRange) GetClone() const;
        WINRT_IMPL_AUTO(int32_t) GetIndex(winrt::Microsoft::UI::Text::TextRangeUnit const& unit) const;
        WINRT_IMPL_AUTO(void) GetPoint(winrt::Microsoft::UI::Text::HorizontalCharacterAlignment const& horizontalAlign, winrt::Microsoft::UI::Text::VerticalCharacterAlignment const& verticalAlign, winrt::Microsoft::UI::Text::PointOptions const& options, winrt::Windows::Foundation::Point& point) const;
        WINRT_IMPL_AUTO(void) GetRect(winrt::Microsoft::UI::Text::PointOptions const& options, winrt::Windows::Foundation::Rect& rect, int32_t& hit) const;
        WINRT_IMPL_AUTO(void) GetText(winrt::Microsoft::UI::Text::TextGetOptions const& options, hstring& value) const;
        WINRT_IMPL_AUTO(void) GetTextViaStream(winrt::Microsoft::UI::Text::TextGetOptions const& options, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        WINRT_IMPL_AUTO(bool) InRange(winrt::Microsoft::UI::Text::ITextRange const& range) const;
        WINRT_IMPL_AUTO(void) InsertImage(int32_t width, int32_t height, int32_t ascent, winrt::Microsoft::UI::Text::VerticalCharacterAlignment const& verticalAlign, param::hstring const& alternateText, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        WINRT_IMPL_AUTO(bool) InStory(winrt::Microsoft::UI::Text::ITextRange const& range) const;
        WINRT_IMPL_AUTO(bool) IsEqual(winrt::Microsoft::UI::Text::ITextRange const& range) const;
        WINRT_IMPL_AUTO(int32_t) Move(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count) const;
        WINRT_IMPL_AUTO(int32_t) MoveEnd(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count) const;
        WINRT_IMPL_AUTO(int32_t) MoveStart(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count) const;
        WINRT_IMPL_AUTO(void) Paste(int32_t format) const;
        WINRT_IMPL_AUTO(void) ScrollIntoView(winrt::Microsoft::UI::Text::PointOptions const& value) const;
        WINRT_IMPL_AUTO(void) MatchSelection() const;
        WINRT_IMPL_AUTO(void) SetIndex(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t index, bool extend) const;
        WINRT_IMPL_AUTO(void) SetPoint(winrt::Windows::Foundation::Point const& point, winrt::Microsoft::UI::Text::PointOptions const& options, bool extend) const;
        WINRT_IMPL_AUTO(void) SetRange(int32_t startPosition, int32_t endPosition) const;
        WINRT_IMPL_AUTO(void) SetText(winrt::Microsoft::UI::Text::TextSetOptions const& options, param::hstring const& value) const;
        WINRT_IMPL_AUTO(void) SetTextViaStream(winrt::Microsoft::UI::Text::TextSetOptions const& options, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        WINRT_IMPL_AUTO(int32_t) StartOf(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, bool extend) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::SelectionOptions) Options() const;
        WINRT_IMPL_AUTO(void) Options(winrt::Microsoft::UI::Text::SelectionOptions const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Text::SelectionType) Type() const;
        WINRT_IMPL_AUTO(int32_t) EndKey(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) HomeKey(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) MoveDown(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) MoveLeft(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) MoveRight(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count, bool extend) const;
        WINRT_IMPL_AUTO(int32_t) MoveUp(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, int32_t count, bool extend) const;
