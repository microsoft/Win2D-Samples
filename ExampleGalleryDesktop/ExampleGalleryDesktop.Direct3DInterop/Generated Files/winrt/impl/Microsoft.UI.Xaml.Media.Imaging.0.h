...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapCreateOptions) CreateOptions() const;
        WINRT_IMPL_AUTO(void) CreateOptions(winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapCreateOptions const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::DecodePixelType) DecodePixelType() const;
        WINRT_IMPL_AUTO(void) DecodePixelType(winrt::Microsoft::UI::Xaml::Media::Imaging::DecodePixelType const& value) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) DownloadProgress(winrt::Microsoft::UI::Xaml::Media::Imaging::DownloadProgressEventHandler const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapImage) CreateInstanceWithUriSource(winrt::Windows::Foundation::Uri const& uriSource) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) CreateOptionsProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) UriSourceProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DecodePixelWidthProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DecodePixelHeightProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DecodePixelTypeProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) IsAnimatedBitmapProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) IsPlayingProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) AutoPlayProperty() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapSource) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) PixelWidthProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) PixelHeightProperty() const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Media_Imaging_IRenderTargetBitmap
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) PixelWidth() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) PixelHeight() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RenderAsync(winrt::Microsoft::UI::Xaml::UIElement const& element) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RenderAsync(winrt::Microsoft::UI::Xaml::UIElement const& element, int32_t scaledWidth, int32_t scaledHeight) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource) CreateInstanceWithDimensions(int32_t pixelWidth, int32_t pixelHeight, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource) CreateInstanceWithDimensionsAndOpacity(int32_t pixelWidth, int32_t pixelHeight, bool isOpaque, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Media_Imaging_ISvgImageSource
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) Opened(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource, winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceOpenedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) OpenFailed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource, winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceFailedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceLoadStatus>) SetSourceAsync(winrt::Windows::Storage::Streams::IRandomAccessStream const& streamSource) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource) CreateInstanceWithUriSource(winrt::Windows::Foundation::Uri const& uriSource, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceLoadStatus) Status() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) UriSourceProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) RasterizePixelWidthProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) RasterizePixelHeightProperty() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::VirtualSurfaceImageSource) CreateInstanceWithDimensions(int32_t pixelWidth, int32_t pixelHeight) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::VirtualSurfaceImageSource) CreateInstanceWithDimensionsAndOpacity(int32_t pixelWidth, int32_t pixelHeight, bool isOpaque) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::WriteableBitmap) CreateInstanceWithDimensions(int32_t pixelWidth, int32_t pixelHeight) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Imaging::XamlRenderingBackgroundTask) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
