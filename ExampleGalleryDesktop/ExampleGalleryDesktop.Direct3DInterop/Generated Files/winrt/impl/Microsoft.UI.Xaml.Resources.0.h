...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoader) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoader) Current() const;
        WINRT_IMPL_AUTO(void) Current(winrt::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoader const& value) const;
    };
