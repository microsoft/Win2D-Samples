...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCachedGeometry) CreateFill(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCachedGeometry) CreateFill(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCachedGeometry) CreateStroke(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry, float strokeWidth) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCachedGeometry) CreateStroke(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry, float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCachedGeometry) CreateStroke(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry, float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle, float flatteningTolerance) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CombineWith(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& otherGeometry, winrt::Windows::Foundation::Numerics::float3x2 const& otherGeometryTransform, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometryCombine const& combine) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CombineWith(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& otherGeometry, winrt::Windows::Foundation::Numerics::float3x2 const& otherGeometryTransform, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometryCombine const& combine, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Stroke(float strokeWidth) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Stroke(float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Stroke(float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Outline() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Outline(winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Simplify(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometrySimplification const& simplification) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Simplify(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometrySimplification const& simplification, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) Transform(winrt::Windows::Foundation::Numerics::float3x2 const& transform) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometryRelation) CompareWith(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& otherGeometry) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometryRelation) CompareWith(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& otherGeometry, winrt::Windows::Foundation::Numerics::float3x2 const& otherGeometryTransform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(float) ComputeArea() const;
        WINRT_IMPL_AUTO(float) ComputeArea(winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(float) ComputePathLength() const;
        WINRT_IMPL_AUTO(float) ComputePathLength(winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) ComputePointOnPath(float distance) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) ComputePointOnPath(float distance, winrt::Windows::Foundation::Numerics::float2& tangent) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) ComputePointOnPath(float length, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance, winrt::Windows::Foundation::Numerics::float2& tangent) const;
        WINRT_IMPL_AUTO(bool) FillContainsPoint(winrt::Windows::Foundation::Numerics::float2 const& point) const;
        WINRT_IMPL_AUTO(bool) FillContainsPoint(winrt::Windows::Foundation::Numerics::float2 const& point, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) ComputeBounds() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) ComputeBounds(winrt::Windows::Foundation::Numerics::float3x2 const& transform) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) ComputeStrokeBounds(float strokeWidth) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) ComputeStrokeBounds(float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) ComputeStrokeBounds(float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(bool) StrokeContainsPoint(winrt::Windows::Foundation::Numerics::float2 const& point, float strokeWidth) const;
        WINRT_IMPL_AUTO(bool) StrokeContainsPoint(winrt::Windows::Foundation::Numerics::float2 const& point, float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle) const;
        WINRT_IMPL_AUTO(bool) StrokeContainsPoint(winrt::Windows::Foundation::Numerics::float2 const& point, float strokeWidth, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeStyle const& strokeStyle, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasTriangleVertices>) Tessellate() const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasTriangleVertices>) Tessellate(winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
        WINRT_IMPL_AUTO(void) SendPathTo(winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasPathReceiver const& streamReader) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasDevice) Device() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateRectangle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Rect const& rect) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateRectangle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float x, float y, float w, float h) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateRoundedRectangle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Rect const& rect, float radiusX, float radiusY) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateRoundedRectangle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float x, float y, float w, float h, float radiusX, float radiusY) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateEllipse(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float2 const& centerPoint, float radiusX, float radiusY) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateEllipse(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float x, float y, float radiusX, float radiusY) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateCircle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float2 const& centerPoint, float radius) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateCircle(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float x, float y, float radius) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreatePath(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasPathBuilder const& pathBuilder) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreatePolygon(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Windows::Foundation::Numerics::float2 const> points) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateGroup(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const> geometries) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateGroup(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const> geometries, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFilledRegionDetermination const& filledRegionDetermination) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateText(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayout const& textLayout) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry) CreateGlyphRun(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float2 const& point, winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, float fontSize, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> glyphs, bool isSideways, uint32_t bidiLevel, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextMeasuringMode const& measuringMode, winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphOrientation const& glyphOrientation) const;
        WINRT_IMPL_AUTO(float) ComputeFlatteningTolerance(float dpi, float maximumZoomFactor) const;
        WINRT_IMPL_AUTO(float) ComputeFlatteningTolerance(float dpi, float maximumZoomFactor, winrt::Windows::Foundation::Numerics::float3x2 const& expectedGeometryTransform) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) DefaultFlatteningTolerance() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatch>) Patches() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMesh) Create(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatch const> patchElements) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatch) CreateCoonsPatch(array_view<winrt::Windows::Foundation::Numerics::float2 const> points, array_view<winrt::Windows::Foundation::Numerics::float4 const> colors, array_view<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatchEdge const> edges) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatch) CreateTensorPatch(array_view<winrt::Windows::Foundation::Numerics::float2 const> points, array_view<winrt::Windows::Foundation::Numerics::float4 const> colors, array_view<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGradientMeshPatchEdge const> edges) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) BeginFigure(winrt::Windows::Foundation::Numerics::float2 const& startPoint, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFigureFill const& figureFill) const;
        WINRT_IMPL_AUTO(void) BeginFigure(winrt::Windows::Foundation::Numerics::float2 const& startPoint) const;
        WINRT_IMPL_AUTO(void) BeginFigure(float startX, float startY, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFigureFill const& figureFill) const;
        WINRT_IMPL_AUTO(void) BeginFigure(float startX, float startY) const;
        WINRT_IMPL_AUTO(void) AddArc(winrt::Windows::Foundation::Numerics::float2 const& endPoint, float radiusX, float radiusY, float rotationAngle, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasSweepDirection const& sweepDirection, winrt::Microsoft::Graphics::Canvas::Geometry::CanvasArcSize const& arcSize) const;
        WINRT_IMPL_AUTO(void) AddArc(winrt::Windows::Foundation::Numerics::float2 const& centerPoint, float radiusX, float radiusY, float startAngle, float sweepAngle) const;
        WINRT_IMPL_AUTO(void) AddCubicBezier(winrt::Windows::Foundation::Numerics::float2 const& controlPoint1, winrt::Windows::Foundation::Numerics::float2 const& controlPoint2, winrt::Windows::Foundation::Numerics::float2 const& endPoint) const;
        WINRT_IMPL_AUTO(void) AddLine(winrt::Windows::Foundation::Numerics::float2 const& endPoint) const;
        WINRT_IMPL_AUTO(void) AddLine(float x, float y) const;
        WINRT_IMPL_AUTO(void) AddQuadraticBezier(winrt::Windows::Foundation::Numerics::float2 const& controlPoint, winrt::Windows::Foundation::Numerics::float2 const& endPoint) const;
        WINRT_IMPL_AUTO(void) SetFilledRegionDetermination(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFilledRegionDetermination const& filledRegionDetermination) const;
        WINRT_IMPL_AUTO(void) SetSegmentOptions(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFigureSegmentOptions const& figureSegmentOptions) const;
        WINRT_IMPL_AUTO(void) EndFigure(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasFigureLoop const& figureLoop) const;
        WINRT_IMPL_AUTO(void) AddGeometry(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry const& geometry) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasPathBuilder) Create(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle) StartCap() const;
        WINRT_IMPL_AUTO(void) StartCap(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle) EndCap() const;
        WINRT_IMPL_AUTO(void) EndCap(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle) DashCap() const;
        WINRT_IMPL_AUTO(void) DashCap(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasCapStyle const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasLineJoin) LineJoin() const;
        WINRT_IMPL_AUTO(void) LineJoin(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasLineJoin const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) MiterLimit() const;
        WINRT_IMPL_AUTO(void) MiterLimit(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasDashStyle) DashStyle() const;
        WINRT_IMPL_AUTO(void) DashStyle(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasDashStyle const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) DashOffset() const;
        WINRT_IMPL_AUTO(void) DashOffset(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<float>) CustomDashStyle() const;
        WINRT_IMPL_AUTO(void) CustomDashStyle(array_view<float const> valueElements) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeTransformBehavior) TransformBehavior() const;
        WINRT_IMPL_AUTO(void) TransformBehavior(winrt::Microsoft::Graphics::Canvas::Geometry::CanvasStrokeTransformBehavior const& value) const;
    };
