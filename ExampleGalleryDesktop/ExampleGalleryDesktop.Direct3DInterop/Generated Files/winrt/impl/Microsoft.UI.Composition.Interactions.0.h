...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Composition::Interactions::IVisualInteractionSource>{ 0xCFB7245C,0x35A6,0x577D,{ 0x95,0x72,0xD3,0x8B,0x3A,0x7B,0xCD,0xA4 } }; // CFB7245C-35A6-577D-9572-D38B3A7BCDA4
    ...
    struct consume_Microsoft_UI_Composition_Interactions_IVisualInteractionSource
    {
        ...
        WINRT_IMPL_AUTO(void) TryRedirectForManipulation(winrt::Microsoft::UI::Input::Experimental::ExpPointerPoint const& pointerPoint) const;
    };
