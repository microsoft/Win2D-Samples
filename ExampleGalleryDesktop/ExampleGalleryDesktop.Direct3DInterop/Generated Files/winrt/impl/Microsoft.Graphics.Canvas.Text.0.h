...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingMode) GetRecommendedRenderingMode(float fontSize, float dpi, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextMeasuringMode const& measuringMode, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingParameters const& renderingParameters) const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextGridFit) GetRecommendedGridFit(float fontSize, float dpi, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextMeasuringMode const& measuringMode, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingParameters const& renderingParameters, winrt::Windows::Foundation::Numerics::float3x2 const& transform, bool isSideways, winrt::Microsoft::Graphics::Canvas::CanvasAntialiasing const& outlineThreshold) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) GlyphBox() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) SubscriptPosition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Size) SubscriptSize() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) SuperscriptPosition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Size) SuperscriptSize() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasTypographicMetrics() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Ascent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Descent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineGap() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) CapHeight() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LowercaseLetterHeight() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) UnderlinePosition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) UnderlineThickness() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) StrikethroughPosition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) StrikethroughThickness() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) CaretSlopeRise() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) CaretSlopeRun() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) CaretOffset() const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasUnicodeRange>) UnicodeRanges() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsMonospaced() const;
        WINRT_IMPL_AUTO(com_array<int32_t>) GetVerticalGlyphVariants(array_view<int32_t const> inputElements) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasVerticalGlyphVariants() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFileFormatType) FileFormatType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontSimulations) Simulations() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsSymbolFont() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) GlyphCount() const;
        WINRT_IMPL_AUTO(com_array<int32_t>) GetGlyphIndices(array_view<uint32_t const> inputElements) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphMetrics>) GetGlyphMetrics(array_view<int32_t const> inputElements, bool isSideways) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphMetrics>) GetGdiCompatibleGlyphMetrics(float fontSize, float dpi, winrt::Windows::Foundation::Numerics::float3x2 const& transform, bool useGdiNatural, array_view<int32_t const> inputElements, bool isSideways) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontWeight) Weight() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStretch) Stretch() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStyle) Style() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) FamilyNames() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) FaceNames() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) GetInformationalStrings(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontInformation const& fontInformation) const;
        WINRT_IMPL_AUTO(bool) HasCharacter(uint32_t unicodeValue) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) GetGlyphRunBounds(winrt::Microsoft::Graphics::Canvas::CanvasDrawingSession const& drawingSession, winrt::Windows::Foundation::Numerics::float2 const& point, float fontSize, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> glyphs, bool isSideways, uint32_t bidiLevel) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<uint8_t>) Panose() const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeatureName>) GetSupportedTypographicFeatureNames(winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeatureName>) GetSupportedTypographicFeatureNames(winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script, param::hstring const& locale) const;
        WINRT_IMPL_AUTO(com_array<bool>) GetTypographicFeatureGlyphSupport(winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script, winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeatureName const& typographicFeatureName, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> glyphsElements) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace>) Fonts() const;
        WINRT_IMPL_AUTO(bool) TryFindFontFace(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, int32_t& index) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontSet) GetMatchingFonts(array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasFontProperty const> propertyElements) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontSet) GetMatchingFonts(param::hstring const& familyName, winrt::Windows::UI::Text::FontWeight const& weight, winrt::Windows::UI::Text::FontStretch const& stretch, winrt::Windows::UI::Text::FontStyle const& style) const;
        WINRT_IMPL_AUTO(uint32_t) CountFontsMatchingProperty(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontProperty const& property) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) GetPropertyValues(uint32_t fontIndex, winrt::Microsoft::Graphics::Canvas::Text::CanvasFontPropertyIdentifier const& propertyIdentifier) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasFontProperty>) GetPropertyValues(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontPropertyIdentifier const& propertyIdentifier, param::hstring const& preferredLocaleNames) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasFontProperty>) GetPropertyValues(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontPropertyIdentifier const& propertyIdentifier) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontSet) Create(winrt::Windows::Foundation::Uri const& uri) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontSet) GetSystemFontSet() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution) Create(winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitutionMethod const& method) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution) CreateWithLocaleAndIgnoreOverrides(winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitutionMethod const& method, param::hstring const& localeName, bool ignoreEnvironmentOverrides) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace) FontFace() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) ScaleFactor() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasScaledFont>>) GetFonts(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextFormat const& textFormat) const;
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedBidi>>) GetBidi() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedBidi>>) GetBidi(param::hstring const& locale) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedBreakpoint>) GetBreakpoints() const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedBreakpoint>) GetBreakpoints(param::hstring const& locale) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution>>) GetNumberSubstitutions() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript>>) GetScript() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript>>) GetScript(param::hstring const& locale) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedGlyphOrientation>>) GetGlyphOrientations() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedGlyphOrientation>>) GetGlyphOrientations(param::hstring const& locale) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasScriptProperties) GetScriptProperties(winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& analyzedScript) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph>) GetGlyphs(winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange const& characterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, float fontSize, bool isSideways, bool isRightToLeft, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph>) GetGlyphs(winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange const& characterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, float fontSize, bool isSideways, bool isRightToLeft, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script, param::hstring const& locale, winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution const& numberSubstitution, param::vector_view<winrt::Windows::Foundation::Collections::IKeyValuePair<winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasTypography>> const& typographyRanges, com_array<int32_t>& clusterMapIndicesElements, com_array<bool>& isShapedAloneGlyphsElements, com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphShaping>& glyphShapingResultsElements) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasJustificationOpportunity>) GetJustificationOpportunities(winrt::Microsoft::Graphics::Canvas::Text::CanvasCharacterRange const& characterRange, winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, float fontSize, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script, array_view<int32_t const> clusterMapIndicesElements, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphShaping const> glyphShapingResultsElements) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph>) ApplyJustificationOpportunities(float lineWidth, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasJustificationOpportunity const> justificationOpportunitiesElements, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> sourceGlyphsElements) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph>) AddGlyphsAfterJustification(winrt::Microsoft::Graphics::Canvas::Text::CanvasFontFace const& fontFace, float fontSize, winrt::Microsoft::Graphics::Canvas::Text::CanvasAnalyzedScript const& script, array_view<int32_t const> clusterMapIndicesElements, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> originalGlyphsElements, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyph const> justifiedGlyphsElements, array_view<winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphShaping const> glyphShapingResultsElements) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextAnalyzer) Create(param::hstring const& text, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection const& textDirection) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextAnalyzer) CreateWithNumberSubstitutionAndVerticalGlyphOrientationAndBidiLevel(param::hstring const& text, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection const& textDirection, winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution const& numberSubstitution, winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation const& verticalGlyphOrientation, uint32_t bidiLevel) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextAnalyzer) CreateWithOptions(param::hstring const& text, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection const& textDirection, winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextAnalyzerOptions const& options) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetLocaleName(int32_t characterIndex, int32_t& characterCount) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasNumberSubstitution) GetNumberSubstitution(int32_t characterIndex, int32_t& characterCount) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation) GetVerticalGlyphOrientation(int32_t characterIndex, int32_t& characterCount) const;
        WINRT_IMPL_AUTO(uint32_t) GetBidiLevel(int32_t characterIndex, int32_t& characterCount) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection) Direction() const;
        WINRT_IMPL_AUTO(void) Direction(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FontFamily() const;
        WINRT_IMPL_AUTO(void) FontFamily(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) FontSize() const;
        WINRT_IMPL_AUTO(void) FontSize(float value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(float) IncrementalTabStop() const;
        WINRT_IMPL_AUTO(void) IncrementalTabStop(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineSpacing() const;
        WINRT_IMPL_AUTO(void) LineSpacing(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineSpacingBaseline() const;
        WINRT_IMPL_AUTO(void) LineSpacingBaseline(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) LocaleName() const;
        WINRT_IMPL_AUTO(void) LocaleName(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalAlignment) VerticalAlignment() const;
        WINRT_IMPL_AUTO(void) VerticalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasHorizontalAlignment) HorizontalAlignment() const;
        WINRT_IMPL_AUTO(void) HorizontalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasHorizontalAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextTrimmingGranularity) TrimmingGranularity() const;
        WINRT_IMPL_AUTO(void) TrimmingGranularity(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextTrimmingGranularity const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) TrimmingDelimiter() const;
        WINRT_IMPL_AUTO(void) TrimmingDelimiter(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) TrimmingDelimiterCount() const;
        WINRT_IMPL_AUTO(void) TrimmingDelimiterCount(int32_t value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasWordWrapping) WordWrapping() const;
        WINRT_IMPL_AUTO(void) WordWrapping(winrt::Microsoft::Graphics::Canvas::Text::CanvasWordWrapping const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasDrawTextOptions) Options() const;
        WINRT_IMPL_AUTO(void) Options(winrt::Microsoft::Graphics::Canvas::Text::CanvasDrawTextOptions const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation) VerticalGlyphOrientation() const;
        WINRT_IMPL_AUTO(void) VerticalGlyphOrientation(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasOpticalAlignment) OpticalAlignment() const;
        WINRT_IMPL_AUTO(void) OpticalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasOpticalAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) LastLineWrapping() const;
        WINRT_IMPL_AUTO(void) LastLineWrapping(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasLineSpacingMode) LineSpacingMode() const;
        WINRT_IMPL_AUTO(void) LineSpacingMode(winrt::Microsoft::Graphics::Canvas::Text::CanvasLineSpacingMode const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTrimmingSign) TrimmingSign() const;
        WINRT_IMPL_AUTO(void) TrimmingSign(winrt::Microsoft::Graphics::Canvas::Text::CanvasTrimmingSign const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject) CustomTrimmingSign() const;
        WINRT_IMPL_AUTO(void) CustomTrimmingSign(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<hstring>) GetSystemFontFamilies() const;
        WINRT_IMPL_AUTO(com_array<hstring>) GetSystemFontFamilies(param::vector_view<hstring> const& localeList) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) Draw(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextRenderer const& textRenderer, winrt::Windows::Foundation::Numerics::float2 const& point, bool isSideways, bool isRightToLeft, winrt::Windows::Foundation::IInspectable const& brush) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Size) Size() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) Baseline() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) SupportsSideways() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) DrawBounds() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasLineBreakCondition) BreakBefore() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasLineBreakCondition) BreakAfter() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<int32_t>) GetFormatChangeIndices() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection) Direction() const;
        WINRT_IMPL_AUTO(void) Direction(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextDirection const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DefaultFontFamily() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) DefaultFontSize() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStretch) DefaultFontStretch() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStyle) DefaultFontStyle() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontWeight) DefaultFontWeight() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) IncrementalTabStop() const;
        WINRT_IMPL_AUTO(void) IncrementalTabStop(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineSpacing() const;
        WINRT_IMPL_AUTO(void) LineSpacing(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) LineSpacingBaseline() const;
        WINRT_IMPL_AUTO(void) LineSpacingBaseline(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DefaultLocaleName() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalAlignment) VerticalAlignment() const;
        WINRT_IMPL_AUTO(void) VerticalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasHorizontalAlignment) HorizontalAlignment() const;
        WINRT_IMPL_AUTO(void) HorizontalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasHorizontalAlignment const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject) CustomTrimmingSign() const;
        WINRT_IMPL_AUTO(void) CustomTrimmingSign(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Size) RequestedSize() const;
        WINRT_IMPL_AUTO(void) RequestedSize(winrt::Windows::Foundation::Size const& value) const;
        WINRT_IMPL_AUTO(float) GetMinimumLineLength() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasBrush) GetBrush(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) GetCustomBrush(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(hstring) GetFontFamily(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(float) GetFontSize(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStretch) GetFontStretch(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontStyle) GetFontStyle(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Text::FontWeight) GetFontWeight(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(hstring) GetLocaleName(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(bool) GetStrikethrough(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(bool) GetUnderline(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject) GetInlineObject(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(void) SetColor(int32_t characterIndex, int32_t characterCount, winrt::Windows::UI::Color const& color) const;
        WINRT_IMPL_AUTO(void) SetBrush(int32_t characterIndex, int32_t characterCount, winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasBrush const& brush) const;
        WINRT_IMPL_AUTO(void) SetCustomBrush(int32_t characterIndex, int32_t characterCount, winrt::Windows::Foundation::IInspectable const& brush) const;
        WINRT_IMPL_AUTO(void) SetFontFamily(int32_t characterIndex, int32_t characterCount, param::hstring const& fontFamily) const;
        WINRT_IMPL_AUTO(void) SetFontSize(int32_t characterIndex, int32_t characterCount, float fontSize) const;
        WINRT_IMPL_AUTO(void) SetFontStretch(int32_t characterIndex, int32_t characterCount, winrt::Windows::UI::Text::FontStretch const& fontStretch) const;
        WINRT_IMPL_AUTO(void) SetFontStyle(int32_t characterIndex, int32_t characterCount, winrt::Windows::UI::Text::FontStyle const& fontStyle) const;
        WINRT_IMPL_AUTO(void) SetFontWeight(int32_t characterIndex, int32_t characterCount, winrt::Windows::UI::Text::FontWeight const& fontWeight) const;
        WINRT_IMPL_AUTO(void) SetLocaleName(int32_t characterIndex, int32_t characterCount, param::hstring const& name) const;
        WINRT_IMPL_AUTO(void) SetStrikethrough(int32_t characterIndex, int32_t characterCount, bool hasStrikethrough) const;
        WINRT_IMPL_AUTO(void) SetUnderline(int32_t characterIndex, int32_t characterCount, bool hasUnderline) const;
        WINRT_IMPL_AUTO(void) SetInlineObject(int32_t characterIndex, int32_t characterCount, winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextInlineObject const& inlineObject) const;
        WINRT_IMPL_AUTO(void) DrawToTextRenderer(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextRenderer const& textRenderer, winrt::Windows::Foundation::Numerics::float2 const& position) const;
        WINRT_IMPL_AUTO(void) DrawToTextRenderer(winrt::Microsoft::Graphics::Canvas::Text::ICanvasTextRenderer const& textRenderer, float x, float y) const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasLineMetrics>) LineMetrics() const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasClusterMetrics>) ClusterMetrics() const;
        WINRT_IMPL_AUTO(void) SetTypography(int32_t characterIndex, int32_t characterCount, winrt::Microsoft::Graphics::Canvas::Text::CanvasTypography const& typography) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTypography) GetTypography(int32_t characterIndex) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) LayoutBounds() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) LayoutBoundsIncludingTrailingWhitespace() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) LineCount() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) MaximumBidiReorderingDepth() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) DrawBounds() const;
        WINRT_IMPL_AUTO(bool) HitTest(winrt::Windows::Foundation::Numerics::float2 const& point) const;
        WINRT_IMPL_AUTO(bool) HitTest(float x, float y) const;
        WINRT_IMPL_AUTO(bool) HitTest(winrt::Windows::Foundation::Numerics::float2 const& point, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion& textLayoutRegion) const;
        WINRT_IMPL_AUTO(bool) HitTest(float x, float y, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion& textLayoutRegion) const;
        WINRT_IMPL_AUTO(bool) HitTest(winrt::Windows::Foundation::Numerics::float2 const& point, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion& textLayoutRegion, bool& trailingSideOfCharacter) const;
        WINRT_IMPL_AUTO(bool) HitTest(float x, float y, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion& textLayoutRegion, bool& trailingSideOfCharacter) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) GetCaretPosition(int32_t characterIndex, bool trailingSideOfCharacter) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) GetCaretPosition(int32_t characterIndex, bool trailingSideOfCharacter, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion& textLayoutRegion) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayoutRegion>) GetCharacterRegions(int32_t characterIndex, int32_t characterCount) const;
        WINRT_IMPL_AUTO(bool) GetPairKerning(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(void) SetPairKerning(int32_t characterIndex, int32_t characterCount, bool hasPairKerning) const;
        WINRT_IMPL_AUTO(float) GetLeadingCharacterSpacing(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(float) GetTrailingCharacterSpacing(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(float) GetMinimumCharacterAdvance(int32_t characterIndex) const;
        WINRT_IMPL_AUTO(void) SetCharacterSpacing(int32_t characterIndex, int32_t characterCount, float leadingSpacing, float trailingSpacing, float minimumAdvance) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation) VerticalGlyphOrientation() const;
        WINRT_IMPL_AUTO(void) VerticalGlyphOrientation(winrt::Microsoft::Graphics::Canvas::Text::CanvasVerticalGlyphOrientation const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasOpticalAlignment) OpticalAlignment() const;
        WINRT_IMPL_AUTO(void) OpticalAlignment(winrt::Microsoft::Graphics::Canvas::Text::CanvasOpticalAlignment const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextLayout) Create(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::hstring const& textString, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextFormat const& textFormat, float requestedWidth, float requestedHeight) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float3x2) GetGlyphOrientationTransform(winrt::Microsoft::Graphics::Canvas::Text::CanvasGlyphOrientation const& glyphOrientation, bool isSideways, winrt::Windows::Foundation::Numerics::float2 const& position) const;
    };
    ...
    struct consume_Microsoft_Graphics_Canvas_Text_ICanvasTextRenderer
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) PixelSnappingDisabled() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingMode) RenderingMode() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextGridFit) GridFit() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingParameters) Create(winrt::Microsoft::Graphics::Canvas::Text::CanvasTextRenderingMode const& textRenderingMode, winrt::Microsoft::Graphics::Canvas::Text::CanvasTextGridFit const& gridFit) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) AddFeature(winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeature const& feature) const;
        WINRT_IMPL_AUTO(void) AddFeature(winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeatureName const& name, uint32_t parameter) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Text::CanvasTypographyFeature>) GetFeatures() const;
    };
