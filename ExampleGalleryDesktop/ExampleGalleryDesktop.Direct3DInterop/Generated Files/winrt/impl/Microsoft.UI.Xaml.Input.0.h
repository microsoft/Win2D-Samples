...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IDoubleTappedRoutedEventArgs>{ 0xDE9300C0,0x3707,0x51AC,{ 0xA3,0xA2,0x8B,0xC5,0x13,0xA5,0x25,0x7A } }; // DE9300C0-3707-51AC-A3A2-8BC513A5257A
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IHoldingRoutedEventArgs>{ 0x05F78DDF,0x9248,0x56FE,{ 0xA7,0x2E,0x8D,0x1B,0xEC,0x2D,0x3F,0xC3 } }; // 05F78DDF-9248-56FE-A72E-8D1BEC2D3FC3
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IManipulationCompletedRoutedEventArgs>{ 0x932321BA,0xD590,0x5000,{ 0xB1,0x69,0xF3,0xAD,0x2B,0xFD,0x39,0xE3 } }; // 932321BA-D590-5000-B169-F3AD2BFD39E3
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IManipulationDeltaRoutedEventArgs>{ 0x4CD9A70D,0x11F5,0x5AB4,{ 0xA9,0x85,0x78,0xBA,0x3D,0x21,0xB4,0xA5 } }; // 4CD9A70D-11F5-5AB4-A985-78BA3D21B4A5
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IManipulationInertiaStartingRoutedEventArgs>{ 0xC1F5771E,0x2F23,0x5EC1,{ 0xA2,0xAB,0xBF,0xC5,0xD5,0x3E,0xB3,0x77 } }; // C1F5771E-2F23-5EC1-A2AB-BFC5D53EB377
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IManipulationStartedRoutedEventArgs>{ 0x7168AD4C,0xE866,0x5AD7,{ 0x92,0x29,0x10,0x16,0x77,0xFA,0xE0,0x52 } }; // 7168AD4C-E866-5AD7-9229-101677FAE052
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IPointer>{ 0xD2B30FC4,0x8E01,0x5B42,{ 0xBA,0xF3,0xAA,0xDD,0xE8,0xE4,0x97,0xC1 } }; // D2B30FC4-8E01-5B42-BAF3-AADDE8E497C1
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IPointerRoutedEventArgs>{ 0x52E918F4,0xA644,0x53ED,{ 0x85,0xA3,0xDF,0xD1,0xA0,0xBE,0xE3,0x9F } }; // 52E918F4-A644-53ED-85A3-DFD1A0BEE39F
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::IRightTappedRoutedEventArgs>{ 0x9412226C,0xCC52,0x57AA,{ 0xAF,0x2C,0xAD,0xF2,0xA8,0xEE,0x0B,0xEB } }; // 9412226C-CC52-57AA-AF2C-ADF2A8EE0BEB
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Input::ITappedRoutedEventArgs>{ 0x303C1302,0xE41C,0x523F,{ 0xBD,0xBB,0x90,0x8C,0xBD,0x87,0x74,0x3C } }; // 303C1302-E41C-523F-BDBB-908CBD87743C
    ...
    struct consume_Microsoft_UI_Xaml_Input_IContextRequestedEventArgs
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        WINRT_IMPL_AUTO(bool) TryGetPosition(winrt::Microsoft::UI::Xaml::UIElement const& relativeTo, winrt::Windows::Foundation::Point& point) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) SearchRoot() const;
        WINRT_IMPL_AUTO(void) SearchRoot(winrt::Microsoft::UI::Xaml::DependencyObject const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::XYFocusNavigationStrategyOverride) XYFocusNavigationStrategyOverride() const;
        WINRT_IMPL_AUTO(void) XYFocusNavigationStrategyOverride(winrt::Microsoft::UI::Xaml::Input::XYFocusNavigationStrategyOverride const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) NewFocusedElement() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) OldFocusedElement() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::guid) CorrelationId() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) GotFocus(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::FocusManagerGotFocusEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) LostFocus(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::FocusManagerLostFocusEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) GettingFocus(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::GettingFocusEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) LosingFocus(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::LosingFocusEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Input::FocusMovementResult>) TryFocusAsync(winrt::Microsoft::UI::Xaml::DependencyObject const& element, winrt::Microsoft::UI::Xaml::FocusState const& value) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Input::FocusMovementResult>) TryMoveFocusAsync(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Input::FocusMovementResult>) TryMoveFocusAsync(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection, winrt::Microsoft::UI::Xaml::Input::FindNextElementOptions const& focusNavigationOptions) const;
        WINRT_IMPL_AUTO(bool) TryMoveFocus(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection, winrt::Microsoft::UI::Xaml::Input::FindNextElementOptions const& focusNavigationOptions) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) FindNextElement(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) FindFirstFocusableElement(winrt::Microsoft::UI::Xaml::DependencyObject const& searchScope) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) FindLastFocusableElement(winrt::Microsoft::UI::Xaml::DependencyObject const& searchScope) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) FindNextElement(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection, winrt::Microsoft::UI::Xaml::Input::FindNextElementOptions const& focusNavigationOptions) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::UIElement) FindNextFocusableElement(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::UIElement) FindNextFocusableElement(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection, winrt::Windows::Foundation::Rect const& hintRect) const;
        WINRT_IMPL_AUTO(bool) TryMoveFocus(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection const& focusNavigationDirection) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) GetFocusedElement() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) GetFocusedElement(winrt::Microsoft::UI::Xaml::XamlRoot const& xamlRoot) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Input_IGettingFocusEventArgs
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) OldFocusedElement() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) NewFocusedElement() const;
        WINRT_IMPL_AUTO(void) NewFocusedElement(winrt::Microsoft::UI::Xaml::DependencyObject const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::FocusState) FocusState() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::FocusNavigationDirection) Direction() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::FocusInputDeviceKind) InputDevice() const;
        ...
        WINRT_IMPL_AUTO(bool) TrySetNewFocusedElement(winrt::Microsoft::UI::Xaml::DependencyObject const& element) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::UI::Xaml::Input::InputScopeName>) Names() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::InputScopeNameValue) NameValue() const;
        WINRT_IMPL_AUTO(void) NameValue(winrt::Microsoft::UI::Xaml::Input::InputScopeNameValue const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::InputScopeName) CreateInstance(winrt::Microsoft::UI::Xaml::Input::InputScopeNameValue const& nameValue) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Input_IKeyboardAccelerator
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) ScopeOwner() const;
        WINRT_IMPL_AUTO(void) ScopeOwner(winrt::Microsoft::UI::Xaml::DependencyObject const& value) const;
        WINRT_IMPL_AUTO(winrt::event_token) Invoked(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::KeyboardAccelerator, winrt::Microsoft::UI::Xaml::Input::KeyboardAcceleratorInvokedEventArgs> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::KeyboardAccelerator) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Input_IKeyboardAcceleratorInvokedEventArgs
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyObject) Element() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::KeyboardAccelerator) KeyboardAccelerator() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) KeyProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) ModifiersProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) IsEnabledProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) ScopeOwnerProperty() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::UIElement) Container() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::UIElement) Container() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::InertiaExpansionBehavior) ExpansionBehavior() const;
        WINRT_IMPL_AUTO(void) ExpansionBehavior(winrt::Microsoft::UI::Xaml::Input::InertiaExpansionBehavior const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::InertiaRotationBehavior) RotationBehavior() const;
        WINRT_IMPL_AUTO(void) RotationBehavior(winrt::Microsoft::UI::Xaml::Input::InertiaRotationBehavior const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::InertiaTranslationBehavior) TranslationBehavior() const;
        WINRT_IMPL_AUTO(void) TranslationBehavior(winrt::Microsoft::UI::Xaml::Input::InertiaTranslationBehavior const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Input::PointerDeviceType) PointerDeviceType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::ManipulationDelta) Delta() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::ManipulationPivot) CreateInstanceWithCenterAndRadius(winrt::Windows::Foundation::Point const& center, double radius) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::ManipulationStartedRoutedEventArgs) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::ManipulationModes) Mode() const;
        WINRT_IMPL_AUTO(void) Mode(winrt::Microsoft::UI::Xaml::Input::ManipulationModes const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::UIElement) Container() const;
        WINRT_IMPL_AUTO(void) Container(winrt::Microsoft::UI::Xaml::UIElement const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::ManipulationPivot) Pivot() const;
        WINRT_IMPL_AUTO(void) Pivot(winrt::Microsoft::UI::Xaml::Input::ManipulationPivot const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::Pointer) Pointer() const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Input::Experimental::ExpPointerPoint) GetCurrentPoint(winrt::Microsoft::UI::Xaml::UIElement const& relativeTo) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::UI::Input::Experimental::ExpPointerPoint>) GetIntermediatePoints(winrt::Microsoft::UI::Xaml::UIElement const& relativeTo) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::StandardUICommandKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(winrt::Microsoft::UI::Xaml::Input::StandardUICommandKind const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::StandardUICommand) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::StandardUICommand) CreateInstanceWithKind(winrt::Microsoft::UI::Xaml::Input::StandardUICommandKind const& kind, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Input_IXamlUICommand
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) ExecuteRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::XamlUICommand, winrt::Microsoft::UI::Xaml::Input::ExecuteRequestedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) CanExecuteRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::XamlUICommand, winrt::Microsoft::UI::Xaml::Input::CanExecuteRequestedEventArgs> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Input::XamlUICommand) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) LabelProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) IconSourceProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) KeyboardAcceleratorsProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) AccessKeyProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DescriptionProperty() const;
