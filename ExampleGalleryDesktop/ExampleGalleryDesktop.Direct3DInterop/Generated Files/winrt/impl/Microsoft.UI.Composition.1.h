...
WINRT_EXPORT namespace winrt::Microsoft::UI::Composition
{
    ...
    struct __declspec(empty_bases) ICompositionProjectedShadow2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICompositionProjectedShadow2>
    {
        ICompositionProjectedShadow2(std::nullptr_t = nullptr) noexcept {}
        ICompositionProjectedShadow2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct __declspec(empty_bases) ICompositionProjectedShadowCaster2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICompositionProjectedShadowCaster2>
    {
        ICompositionProjectedShadowCaster2(std::nullptr_t = nullptr) noexcept {}
        ICompositionProjectedShadowCaster2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct __declspec(empty_bases) ICompositionProjectedShadowReceiver2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICompositionProjectedShadowReceiver2>
    {
        ICompositionProjectedShadowReceiver2(std::nullptr_t = nullptr) noexcept {}
        ICompositionProjectedShadowReceiver2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
