...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) Hide(winrt::Microsoft::UI::Composition::Visual const& subtree) const;
        WINRT_IMPL_AUTO(void) ShowMemoryUsage(winrt::Microsoft::UI::Composition::Visual const& subtree) const;
        WINRT_IMPL_AUTO(void) ShowOverdraw(winrt::Microsoft::UI::Composition::Visual const& subtree, winrt::Microsoft::UI::Composition::Diagnostics::CompositionDebugOverdrawContentKinds const& contentKinds) const;
        WINRT_IMPL_AUTO(void) ShowRedraw(winrt::Microsoft::UI::Composition::Visual const& subtree) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Diagnostics::CompositionDebugHeatMaps) HeatMaps() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Diagnostics::CompositionDebugSettings) TryGetSettings(winrt::Microsoft::UI::Composition::Compositor const& compositor) const;
    };
