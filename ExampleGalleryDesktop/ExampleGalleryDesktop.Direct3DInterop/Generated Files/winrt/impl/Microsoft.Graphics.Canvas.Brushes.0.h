...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::ICanvasImage) Image() const;
        WINRT_IMPL_AUTO(void) Image(winrt::Microsoft::Graphics::Canvas::ICanvasImage const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect>) SourceRectangle() const;
        WINRT_IMPL_AUTO(void) SourceRectangle(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasImageInterpolation) Interpolation() const;
        WINRT_IMPL_AUTO(void) Interpolation(winrt::Microsoft::Graphics::Canvas::CanvasImageInterpolation const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasImageBrush) Create(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasImageBrush) CreateWithImage(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Microsoft::Graphics::Canvas::ICanvasImage const& image) const;
    };
    ...
    struct consume_Microsoft_Graphics_Canvas_Brushes_ICanvasLinearGradientBrush
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop>) Stops() const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr>) StopsHdr() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior) EdgeBehavior() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasColorSpace) PreInterpolationSpace() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasColorSpace) PostInterpolationSpace() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasBufferPrecision) BufferPrecision() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateSimple(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::UI::Color const& startColor, winrt::Windows::UI::Color const& endColor) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateWithStops(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateWithEdgeBehaviorAndAlphaMode(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateWithEdgeBehaviorAndInterpolationOptions(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode, winrt::Microsoft::Graphics::Canvas::CanvasColorSpace const& preInterpolationSpace, winrt::Microsoft::Graphics::Canvas::CanvasColorSpace const& postInterpolationSpace, winrt::Microsoft::Graphics::Canvas::CanvasBufferPrecision const& bufferPrecision) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float4 const& startColorHdr, winrt::Windows::Foundation::Numerics::float4 const& endColorHdr) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr const> gradientStopsHdr) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr const> gradientStopsHdr, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode) const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasLinearGradientBrush) CreateRainbow(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float eldritchness) const;
    };
    ...
    struct consume_Microsoft_Graphics_Canvas_Brushes_ICanvasRadialGradientBrush
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) OriginOffset() const;
        WINRT_IMPL_AUTO(void) OriginOffset(winrt::Windows::Foundation::Numerics::float2 const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RadiusX() const;
        WINRT_IMPL_AUTO(void) RadiusX(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RadiusY() const;
        WINRT_IMPL_AUTO(void) RadiusY(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop>) Stops() const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr>) StopsHdr() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior) EdgeBehavior() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::CanvasColorSpace) PreInterpolationSpace() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateSimple(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::UI::Color const& startColor, winrt::Windows::UI::Color const& endColor) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateWithStops(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateWithEdgeBehaviorAndAlphaMode(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateWithEdgeBehaviorAndInterpolationOptions(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStop const> gradientStops, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode, winrt::Microsoft::Graphics::Canvas::CanvasColorSpace const& preInterpolationSpace, winrt::Microsoft::Graphics::Canvas::CanvasColorSpace const& postInterpolationSpace, winrt::Microsoft::Graphics::Canvas::CanvasBufferPrecision const& bufferPrecision) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float4 const& startColorHdr, winrt::Windows::Foundation::Numerics::float4 const& endColorHdr) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr const> gradientStops) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, array_view<winrt::Microsoft::Graphics::Canvas::Brushes::CanvasGradientStopHdr const> gradientStops, winrt::Microsoft::Graphics::Canvas::CanvasEdgeBehavior const& edgeBehavior, winrt::Microsoft::Graphics::Canvas::CanvasAlphaMode const& alphaMode) const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasRadialGradientBrush) CreateRainbow(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, float eldritchness) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasSolidColorBrush) Create(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::UI::Color const& color) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Canvas::Brushes::CanvasSolidColorBrush) CreateHdr(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, winrt::Windows::Foundation::Numerics::float4 const& colorHdr) const;
    };
