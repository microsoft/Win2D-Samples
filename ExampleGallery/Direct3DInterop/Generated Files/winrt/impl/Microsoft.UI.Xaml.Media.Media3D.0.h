...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Media_Media3D_ICompositeTransform3DStatics
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) CenterZProperty() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) ScaleZProperty() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) TranslateZProperty() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D) Identity() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D) Multiply(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& matrix1, winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& matrix2) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D) FromElements(double m11, double m12, double m13, double m14, double m21, double m22, double m23, double m24, double m31, double m32, double m33, double m34, double offsetX, double offsetY, double offsetZ, double m44) const;
        WINRT_IMPL_AUTO(bool) GetHasInverse(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& target) const;
        WINRT_IMPL_AUTO(bool) GetIsIdentity(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& target) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D) Invert(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& target) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DepthProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) OffsetXProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) OffsetYProperty() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Transform3D) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
