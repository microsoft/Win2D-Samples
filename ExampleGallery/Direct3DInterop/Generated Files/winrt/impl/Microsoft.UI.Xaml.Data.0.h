...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Data_IBinding
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::BindingMode) Mode() const;
        WINRT_IMPL_AUTO(void) Mode(winrt::Microsoft::UI::Xaml::Data::BindingMode const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::RelativeSource) RelativeSource() const;
        WINRT_IMPL_AUTO(void) RelativeSource(winrt::Microsoft::UI::Xaml::Data::RelativeSource const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ElementName() const;
        WINRT_IMPL_AUTO(void) ElementName(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::IValueConverter) Converter() const;
        WINRT_IMPL_AUTO(void) Converter(winrt::Microsoft::UI::Xaml::Data::IValueConverter const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::UpdateSourceTrigger) UpdateSourceTrigger() const;
        WINRT_IMPL_AUTO(void) UpdateSourceTrigger(winrt::Microsoft::UI::Xaml::Data::UpdateSourceTrigger const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::BindingBase) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Data_IBindingExpression
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::Binding) ParentBinding() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::Binding) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) SetBinding(winrt::Microsoft::UI::Xaml::DependencyObject const& target, winrt::Microsoft::UI::Xaml::DependencyProperty const& dp, winrt::Microsoft::UI::Xaml::Data::BindingBase const& binding) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Data_ICollectionView
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) CurrentChanging(winrt::Microsoft::UI::Xaml::Data::CurrentChangingEventHandler const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Data::LoadMoreItemsResult>) LoadMoreItemsAsync(uint32_t count) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::ICollectionView) CreateView() const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Data_ICollectionViewSource
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) Source() const;
        WINRT_IMPL_AUTO(void) Source(winrt::Windows::Foundation::IInspectable const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::ICollectionView) View() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsSourceGrouped() const;
        WINRT_IMPL_AUTO(void) IsSourceGrouped(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::PropertyPath) ItemsPath() const;
        WINRT_IMPL_AUTO(void) ItemsPath(winrt::Microsoft::UI::Xaml::PropertyPath const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) SourceProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) ViewProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) IsSourceGroupedProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) ItemsPathProperty() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::CurrentChangingEventArgs) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::CurrentChangingEventArgs) CreateWithCancelableParameter(bool isCancelable, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::ICustomProperty) GetCustomProperty(param::hstring const& name) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::ICustomProperty) GetIndexedProperty(param::hstring const& name, winrt::Windows::UI::Xaml::Interop::TypeName const& type) const;
    ...
    struct consume_Microsoft_UI_Xaml_Data_IDataErrorsChangedEventArgs
    {
        ...
        WINRT_IMPL_AUTO(void) PropertyName(param::hstring const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::DataErrorsChangedEventArgs) CreateInstance(param::hstring const& name) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::ItemIndexRange) CreateInstance(int32_t firstIndex, uint32_t length, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) RangesChanged(winrt::Microsoft::UI::Xaml::Data::ItemIndexRange const& visibleRange, param::vector_view<winrt::Microsoft::UI::Xaml::Data::ItemIndexRange> const& trackedItems) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasErrors() const;
        WINRT_IMPL_AUTO(winrt::event_token) ErrorsChanged(winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Data::DataErrorsChangedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) ErrorsChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Foundation::IInspectable>) GetErrors(param::hstring const& propertyName) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) PropertyChanged(winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventHandler const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventArgs) CreateInstance(param::hstring const& name, winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::RelativeSourceMode) Mode() const;
        WINRT_IMPL_AUTO(void) Mode(winrt::Microsoft::UI::Xaml::Data::RelativeSourceMode const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Data::RelativeSource) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) SelectRange(winrt::Microsoft::UI::Xaml::Data::ItemIndexRange const& itemIndexRange) const;
        WINRT_IMPL_AUTO(void) DeselectRange(winrt::Microsoft::UI::Xaml::Data::ItemIndexRange const& itemIndexRange) const;
        WINRT_IMPL_AUTO(bool) IsSelected(int32_t index) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::UI::Xaml::Data::ItemIndexRange>) GetSelectedRanges() const;
    };
