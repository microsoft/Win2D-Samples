...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Canvas::Brushes
{
    ...
    struct __declspec(empty_bases) CanvasImageBrush : winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasImageBrush
    {
    ...
    struct __declspec(empty_bases) CanvasLinearGradientBrush : winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasLinearGradientBrush
    {
    ...
    struct __declspec(empty_bases) CanvasRadialGradientBrush : winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasRadialGradientBrush
    {
    ...
    struct __declspec(empty_bases) CanvasSolidColorBrush : winrt::Microsoft::Graphics::Canvas::Brushes::ICanvasSolidColorBrush
    {
