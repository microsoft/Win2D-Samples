...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Markup_IComponentConnector
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IComponentConnector) GetBindingConnector(int32_t connectionId, winrt::Windows::Foundation::IInspectable const& target) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::MarkupExtension) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Markup_IMarkupExtensionOverrides
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) ProvideValue(winrt::Microsoft::UI::Xaml::IXamlServiceProvider const& serviceProvider) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) TargetObject() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) TargetProperty() const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Markup_IProvideValueTargetProperty
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Interop::TypeName) DeclaringType() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) RootObject() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::XamlBinaryWriterErrorInformation) Write(param::vector<winrt::Windows::Storage::Streams::IRandomAccessStream> const& inputStreams, param::vector<winrt::Windows::Storage::Streams::IRandomAccessStream> const& outputStreams, winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider const& xamlMetadataProvider) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DataTemplateComponentProperty() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IDataTemplateComponent) GetDataTemplateComponent(winrt::Microsoft::UI::Xaml::DependencyObject const& element) const;
        WINRT_IMPL_AUTO(void) SetDataTemplateComponent(winrt::Microsoft::UI::Xaml::DependencyObject const& element, winrt::Microsoft::UI::Xaml::Markup::IDataTemplateComponent const& value) const;
        WINRT_IMPL_AUTO(void) SuspendRendering(winrt::Microsoft::UI::Xaml::UIElement const& target) const;
        WINRT_IMPL_AUTO(void) ResumeRendering(winrt::Microsoft::UI::Xaml::UIElement const& target) const;
        ...
        WINRT_IMPL_AUTO(void) SetPropertyFromString(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, param::hstring const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromBoolean(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, bool value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromChar16(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, char16_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromDateTime(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::DateTime const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromDouble(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, double value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromInt32(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, int32_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromUInt32(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, uint32_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromInt64(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, int64_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromUInt64(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, uint64_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromSingle(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, float value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromPoint(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::Point const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromRect(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::Rect const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromSize(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::Size const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromTimeSpan(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::TimeSpan const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromByte(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, uint8_t value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromUri(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::Uri const& value) const;
        WINRT_IMPL_AUTO(void) SetPropertyFromObject(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::Foundation::IInspectable const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) UnloadObject(winrt::Microsoft::UI::Xaml::DependencyObject const& element) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Markup_IXamlMember
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Name() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) TargetType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) Type() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) GetXamlType(winrt::Windows::UI::Xaml::Interop::TypeName const& type) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) GetXamlType(param::hstring const& fullName) const;
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::UI::Xaml::Markup::XmlnsDefinition>) GetXmlnsDefinitions() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) BaseType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlMember) ContentProperty() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) ItemType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) KeyType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlType) BoxedType() const;
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Markup::IXamlMember) GetMember(param::hstring const& name) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Interop::TypeName) Resolve(param::hstring const& qualifiedTypeName) const;
    };
