...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::IUIElement>{ 0xC6A6B834,0x85F2,0x5A6A,{ 0x87,0xE3,0x12,0x54,0x75,0xFF,0xEE,0x44 } }; // C6A6B834-85F2-5A6A-87E3-125475FFEE44
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::IUIElementProtected>{ 0xDAF64AC6,0x6A6D,0x5F58,{ 0xB3,0x26,0x29,0x6B,0xF1,0x14,0xCB,0xBA } }; // DAF64AC6-6A6D-5F58-B326-296BF114CBBA
    ...
    struct consume_Microsoft_UI_Xaml_IUIElement
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation>) StartDragAsync(winrt::Microsoft::UI::Input::Experimental::ExpPointerPoint const& pointerPoint) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Core::CoreCursor) ProtectedCursor() const;
        WINRT_IMPL_AUTO(void) ProtectedCursor(winrt::Windows::UI::Core::CoreCursor const& value) const;
    };
