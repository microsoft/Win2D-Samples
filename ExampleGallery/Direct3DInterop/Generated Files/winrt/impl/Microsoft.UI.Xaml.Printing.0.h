...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Printing_IPrintDocument
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) Paginate(winrt::Microsoft::UI::Xaml::Printing::PaginateEventHandler const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) GetPreviewPage(winrt::Microsoft::UI::Xaml::Printing::GetPreviewPageEventHandler const& handler) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) AddPages(winrt::Microsoft::UI::Xaml::Printing::AddPagesEventHandler const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) AddPage(winrt::Microsoft::UI::Xaml::UIElement const& pageVisual) const;
        WINRT_IMPL_AUTO(void) AddPagesComplete() const;
        WINRT_IMPL_AUTO(void) SetPreviewPageCount(int32_t count, winrt::Microsoft::UI::Xaml::Printing::PreviewPageCountType const& type) const;
        WINRT_IMPL_AUTO(void) SetPreviewPage(int32_t pageNumber, winrt::Microsoft::UI::Xaml::UIElement const& pageVisual) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Printing::PrintDocument) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) DocumentSourceProperty() const;
    };
